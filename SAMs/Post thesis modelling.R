...
plot(A1preds, ylab="Latitude", xlab="Longitude", main="A2 - 4m x 4m" )
aggregated.r.A1 <- raster::aggregate(A1preds, fact = 10, fun = sum)  
plot(aggregated.r.A1, ylab="Latitude", xlab="Longitude", main="A2") 

plot(A2preds, ylab="Latitude", xlab="Longitude", main="A1 - 4m x 4m" )
aggregated.r.A2 <- raster::aggregate(A2preds, fact = 20, fun = sum)  
plot(aggregated.r.A2, ylab="Latitude", xlab="Longitude", main="A1") 
